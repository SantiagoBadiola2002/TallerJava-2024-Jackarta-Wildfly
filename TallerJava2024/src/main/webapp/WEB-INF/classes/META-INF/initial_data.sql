...
insert into gestion_usuario values ('NACIONAL', 1, 'usu1@gmail.com', 'Juan', null, null);
insert into gestion_clienteTelepeaje values (1, null,  1, 1);
update gestion_usuario SET clienteTelepeaje_idClienteTelepeaje = 1 WHERE id=1;
